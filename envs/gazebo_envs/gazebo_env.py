...
class GazeboEnv(gym.Env):
    ...
    def __init__(self, simulator, ctrl_range=(-1, 1), frame_skip=None, rgb_rendering_tracking=False):
    ...
    def _set_action_space(self, ctrl_range):
        ...
        low, high = bounds
        self.action_space = spaces.Box(low=low, high=high, dtype=np.float32)  # TODO: float32 okay?
